          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2">Comment contacter un vendeur ?</h3>
                  <p className="text-gray-700">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2">Qu'est-ce qu'une annonce premium ?</h3>
                  <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold mb-4">Guide de Sécurité</h2>
              
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-semibold mb-2">Conseils pour les acheteurs</h3>
              ...
              <div className="bg-blue-50 p-4 rounded-lg mt-4">
                <h3 className="font-semibold mb-2">Conseils pour les vendeurs</h3>
                <ul className="list-disc pl-5 space-y-1 text-gray-700">
