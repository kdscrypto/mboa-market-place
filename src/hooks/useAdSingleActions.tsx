...
/**
 * Hook pour les actions individuelles de modération (approuver/rejeter/supprimer)
 */
export const useAdSingleActions = (
  ...
  const handleApproveAd = async (adId: string) => {
    ...
    try {
      console.log("useAdSingleActions: Approving ad:", adId);
  ...
  const handleRejectAd = async (adId: string, rejectMessage?: string) => {
    ...
    try {
      console.log("useAdSingleActions: Rejecting ad:", adId, "with message:", rejectMessage);
  ...
  const handleDeleteAd = async (adId: string) => {
    ...
    try {
      console.log("useAdSingleActions: Deleting ad:", adId);
